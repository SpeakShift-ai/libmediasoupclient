...
namespace mediasoupclient
{
    ...
    const rtc::scoped_refptr<webrtc::RtpReceiverInterface>& Consumer::GetRtpReceiver() const
	{
		MSC_TRACE();
    ...
    const rtc::scoped_refptr<webrtc::MediaStreamTrackInterface>& Consumer::GetTrack() const
	{
		MSC_TRACE();
